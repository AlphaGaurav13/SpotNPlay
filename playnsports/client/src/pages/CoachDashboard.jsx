...
const SPORTS = ['football', 'cricket', 'basketball', 'tennis', 'badminton', 'volleyball', 'boxing'];
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .input-field {
        ...
        border-radius: 12px; padding: 12px 14px; color: white; font-size: 14px; outline: none;
        transition: all 0.3s ease; font-family: 'DM Sans', sans-serif;
      }
      .input-field:focus { border-color: rgba(74,222,128,0.4); background: rgba(255,255,255,0.05); box-shadow: 0 0 0 3px rgba(74,222,128,0.06); }
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="animate-fadeUp-2 glass-card">
            <h2 className="font-bebas text-2xl tracking-wide text-white mb-5">PERSONAL DETAILS</h2>
          ...
          <div className="animate-fadeUp-3 glass-card">
            <h2 className="font-bebas text-2xl tracking-wide text-white mb-5">PROFESSIONAL DETAILS</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
