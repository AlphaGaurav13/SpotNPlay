...
const CoachesPage = () => {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .coach-card:hover { border-color: rgba(74,222,128,0.25); transform: translateY(-5px); box-shadow: 0 15px 40px rgba(0,0,0,0.3); background: rgba(255,255,255,0.04); }
      .sport-pill {
        padding: 8px 18px; border-radius: 100px; font-size: 13px; font-weight: 600;
        transition: all 0.2s ease; cursor: pointer; border: 1px solid rgba(255,255,255,0.08);
      ...
      .sport-pill:hover { color: white; border-color: rgba(255,255,255,0.15); }
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-white font-bold truncate">{coach.fullName}</p>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    ...
                    <span className="text-xs bg-white/5 border border-white/8 text-gray-400 px-2.5 py-1 rounded-full capitalize">
                      {coach.sport}
                    </span>
                    <span className="text-xs bg-white/5 border border-white/8 text-gray-400 px-2.5 py-1 rounded-full">
