...
const GroupPage = () => {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .label { font-size: 11px; color: rgba(255,255,255,0.3); text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 6px; display: block; }
  ...
  const getSportBg = (sport) => {
    const map = { football: 'rgba(34,197,94,0.1)', cricket: 'rgba(59,130,246,0.1)', basketball: 'rgba(249,115,22,0.1)', tennis: 'rgba(234,179,8,0.1)', badminton: 'rgba(168,85,247,0.1)', volleyball: 'rgba(239,68,68,0.1)' };
    ...
    <div className="min-h-screen bg-[#060606] text-white" style={{ fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="animate-fadeUp-2 create-panel mb-8">
          <h2 className="font-bebas text-2xl tracking-wide text-white mb-6">CREATE A GROUP</h2>
          ...
          <div className="flex gap-2 mb-6 overflow-x-auto pb-1">
            {[
              ...
              >
                {tab.label}
                {tab.count > 0 && (
                  <span className={`ml-2 text-xs px-2 py-0.5 rounded-full ${activeTab === tab.id ? 'bg-green-400/20' : 'bg-white/8'}`}>
                    {tab.count}
                  </span>
                )}
              </button>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 flex-wrap mb-2">
                          <div>
                            ...
                            <p className="text-gray-600 text-xs mt-0.5">
                              Created by <span className="text-gray-400">{group.createdBy?.name}</span>
                            </p>
                          </div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-3">
                          <span className="text-xs bg-white/4 border border-white/8 text-gray-400 px-2 py-1 rounded-full capitalize">
                            {getSportEmoji(group.sport)} {group.sport}
                          </span>
                          <span className={`text-xs px-2 py-1 rounded-full border border-white/8 bg-white/4 ${deadline.color}`}>
                            ⏰ {deadline.text}
                          </span>
                          <span className="text-xs bg-white/4 border border-white/8 text-gray-400 px-2 py-1 rounded-full">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-500 text-sm mb-1">
                          Invited by <span className="text-gray-300">{group.createdBy?.name}</span>
                        </p>
