...
const CoachProfile = () => {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .glass-card { background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06); border-radius: 24px; padding: 24px; }
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                ...
                <span className="text-xs bg-white/5 border border-white/8 text-gray-400 px-3 py-1 rounded-full capitalize">{coach.coachingLevel}</span>
                <span className="text-xs bg-white/5 border border-white/8 text-gray-400 px-3 py-1 rounded-full">{coach.experience} yrs experience</span>
                {coach.hourlyRate > 0 && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="md:col-span-2 flex flex-col gap-5">
            ...
            {coach.bio && (
              <div className="animate-fadeUp-2 glass-card">
                <h2 className="font-bebas text-xl tracking-wide text-white mb-3">ABOUT</h2>
            ...
            {/* Details */}
            <div className="animate-fadeUp-2 glass-card">
              <h2 className="font-bebas text-xl tracking-wide text-white mb-3">DETAILS</h2>
              <div>
                <div className="info-row">
                  <span className="text-gray-600 text-sm">Sport</span>
                  <span className="text-white text-sm capitalize">{SPORT_EMOJI[coach.sport]} {coach.sport}</span>
                </div>
                <div className="info-row">
                  <span className="text-gray-600 text-sm">Experience</span>
                  <span className="text-white text-sm">{coach.experience} years</span>
                </div>
                <div className="info-row">
                  <span className="text-gray-600 text-sm">Coaching Level</span>
                  <span className="text-white text-sm capitalize">{coach.coachingLevel}</span>
                </div>
                <div className="info-row">
                  <span className="text-gray-600 text-sm">Location</span>
                  <span className="text-white text-sm">{coach.city}, {coach.state}</span>
                </div>
                {coach.certifications && (
                  <div className="info-row">
                    <span className="text-gray-600 text-sm">Certifications</span>
                    <span className="text-white text-sm text-right max-w-xs">{coach.certifications}</span>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="animate-fadeUp-3 flex flex-col gap-4">
            <div className="glass-card">
              <h2 className="font-bebas text-xl tracking-wide text-white mb-4">HIRE COACH</h2>
              {coach.hourlyRate > 0 && (
