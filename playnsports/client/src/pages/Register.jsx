  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .input-field {
        ...
        border-radius: 14px; padding: 14px 16px; color: white; font-size: 15px;
        transition: all 0.3s ease; outline: none; font-family: 'DM Sans', sans-serif;
      }
      .input-field:focus { background: rgba(255,255,255,0.05); border-color: rgba(74,222,128,0.5); box-shadow: 0 0 0 3px rgba(74,222,128,0.08); }
      ...
      .toggle-inactive { background: transparent; color: rgba(255,255,255,0.3); border: 1px solid transparent; }
      .toggle-inactive:hover { color: rgba(255,255,255,0.6); }
      .otp-input {
        width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(74,222,128,0.3);
        border-radius: 14px; padding: 16px; color: white; font-size: 28px; font-weight: 700;
      ...
      .google-btn {
        ...
        color: rgba(255,255,255,0.8); font-weight: 500; font-size: 15px; border-radius: 14px;
        padding: 14px; transition: all 0.3s ease; text-decoration: none;
      }
      .google-btn:hover { background: rgba(255,255,255,0.06); border-color: rgba(255,255,255,0.15); color: white; transform: translateY(-1px); }
    `;
        ...
        <div className="animate-fadeUp-2 bg-white/2 border border-white/6 rounded-3xl p-8 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="animate-fadeUp-3 md:col-span-2">
                  ...
                  <input type="text" name="name" value={form.name} onChange={handleChange}
                    ...
                    placeholder="Gaurav Kumar" required className="input-field"
                ...
                <div className="animate-fadeUp-3">
                  ...
                  <input type="email" name="email" value={form.email} onChange={handleChange}
                    ...
                    placeholder="gaurav@gmail.com" required className="input-field"
                ...
                <div className="animate-fadeUp-3">
                  ...
                  <input type="tel" name="phone" value={form.phone} onChange={handleChange}
                    ...
                    placeholder="9999999999" required className="input-field"
          ...
          {step === 2 && (
            <div className="flex flex-col gap-5">
              ...
              <button onClick={() => { setStep(1); setOtp(''); setError(''); }} className="text-gray-600 hover:text-white text-sm transition-colors text-center">
                ← Change Details
              </button>
