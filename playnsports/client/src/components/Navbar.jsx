        ...
        <div className="fixed top-[65px] left-0 right-0 z-40 md:hidden menu-animate">
          <div className="mx-4 bg-[#111] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
            <div className="flex flex-col p-4 gap-1">
              {user ? (
                <>
                  <Link to="/map" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-gray-300 hover:text-white transition-all">
                    <span>🗺️</span> Map
                  </Link>
                  ...
                  {user.role === 'ground_owner' && (
                    <Link to="/owner/dashboard" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-gray-300 hover:text-white transition-all">
                ...
                <>
                  ...
                  <Link to="/otp-login" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-gray-300 hover:text-white transition-all">
